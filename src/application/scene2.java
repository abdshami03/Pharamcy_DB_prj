...
public class scene2 implements Initializable {
	...
	public void placeorder(ActionEvent actionEvent) {
		...
		if (!isNumeric(quantityText) || Integer.parseInt(quantityText) < 0 || selectedItem == null
				|| selectedItem1 == null) {
			showErrorMessage("Invalid Quantity", "Invalid Input");
		} else {
			int quantity = Integer.parseInt(quantityText);
			Data.updateMedicineQuantity(selectedItem1.getMid(), selectedItem1.getCid(),
					selectedItem1.getQuantity() + quantity);
