...
public class controller implements Initializable {
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		...
		cname.setOnEditCommit((TableColumn.CellEditEvent<Customer, String> t) -> {
			((Customer) t.getTableView().getItems().get(t.getTablePosition().getRow())).setCname(t.getNewValue());
		...
		gender.setOnEditCommit((TableColumn.CellEditEvent<Customer, String> t) -> {
			try {
				...
				if (!Objects.equals(newValue, "Male") && !Objects.equals(newValue, "male")
						&& !Objects.equals(newValue, "Female") && !Objects.equals(newValue, "female")) {
					throw new NumberFormatException();
				}
...
//********************************* Doctor Table set 
		...
		DName.setOnEditCommit((TableColumn.CellEditEvent<Doctor, String> t) -> {
			((Doctor) t.getTableView().getItems().get(t.getTablePosition().getRow())).setDname(t.getNewValue());
		...
		Dspecialty.setOnEditCommit((TableColumn.CellEditEvent<Doctor, String> t) -> {
			((Doctor) t.getTableView().getItems().get(t.getTablePosition().getRow())).setSpecialty(t.getNewValue());
		...
		col_company.setOnEditCommit((TableColumn.CellEditEvent<Insurance, String> t) -> {
			((Insurance) t.getTableView().getItems().get(t.getTablePosition().getRow())).setCompany(t.getNewValue());
		...
		col_instype.setOnEditCommit((TableColumn.CellEditEvent<Insurance, String> t) -> {
			((Insurance) t.getTableView().getItems().get(t.getTablePosition().getRow())).setInstype(t.getNewValue());
		...
		col_coverageEdate.setOnEditCommit((TableColumn.CellEditEvent<Insurance, String> t) -> {
			((Insurance) t.getTableView().getItems().get(t.getTablePosition().getRow()))
		...
		col_coverageSdate.setOnEditCommit((TableColumn.CellEditEvent<Insurance, String> t) -> {
			((Insurance) t.getTableView().getItems().get(t.getTablePosition().getRow()))
		...
		colInsurance = FXCollections.observableArrayList("insid", "company", "instype", "coverageEdate",
				"coverageSdate");
		...
		paymentMethIN.setOnEditCommit((TableColumn.CellEditEvent<Invoice, String> t) -> {
			((Invoice) t.getTableView().getItems().get(t.getTablePosition().getRow())).setPaymentMeth(t.getNewValue());
		...
		addresstab.setOnEditCommit((TableColumn.CellEditEvent<Manufacturer, String> t) -> {
			((Manufacturer) t.getTableView().getItems().get(t.getTablePosition().getRow())).setAddress(t.getNewValue());
		...
		mnametab.setOnEditCommit((TableColumn.CellEditEvent<Manufacturer, String> t) -> {
			((Manufacturer) t.getTableView().getItems().get(t.getTablePosition().getRow())).setMname(t.getNewValue());
...
//****************************************  Prescription  Table set 
		...
		tabper_text.setOnEditCommit((TableColumn.CellEditEvent<Prescription, String> t) -> {
			((Prescription) t.getTableView().getItems().get(t.getTablePosition().getRow()))
					.setPer_text(t.getNewValue());
			Data.updatePrescriptionText(t.getRowValue().getDid(), t.getRowValue().getCusid(), t.getRowValue().getMid(),
					t.getNewValue());
		});
		tabquantity.setCellValueFactory(new PropertyValueFactory<Prescription, Integer>("quantity"));
		tabquantity
				.setCellFactory(TextFieldTableCell.<Prescription, Integer>forTableColumn(new IntegerStringConverter()));
		tabquantity.setOnEditCommit((TableColumn.CellEditEvent<Prescription, Integer> t) -> {
			try {
				...
				Data.updatePrescriptionQuantity(t.getRowValue().getDid(), t.getRowValue().getCusid(),
						t.getRowValue().getMid(), newValue);
			} catch (NumberFormatException e) {
				Data.Error();
				System.out.println("Invalid age input");
		...
		tabper_date.setOnEditCommit((TableColumn.CellEditEvent<Prescription, String> t) -> {
			((Prescription) t.getTableView().getItems().get(t.getTablePosition().getRow()))
					.setPer_date(t.getNewValue());
			Data.updatePrescriptionDate(t.getRowValue().getDid(), t.getRowValue().getCusid(), t.getRowValue().getMid(),
					t.getNewValue());
		});
		listPrescription = FXCollections.observableArrayList(Data.dataPrescription);
		valuePrescription = FXCollections.observableArrayList("did", "cusid", "mid", "per_text", "per_date",
				"quantity");
		...
		mTypemed.setOnEditCommit((TableColumn.CellEditEvent<Medicine, String> t) -> {
			((Medicine) t.getTableView().getItems().get(t.getTablePosition().getRow())).setMType(t.getNewValue());
		...
		dosagemed.setOnEditCommit((TableColumn.CellEditEvent<Medicine, String> t) -> {
			((Medicine) t.getTableView().getItems().get(t.getTablePosition().getRow())).setDosage(t.getNewValue());
		...
		expiryDatemed.setOnEditCommit((TableColumn.CellEditEvent<Medicine, String> t) -> {
			((Medicine) t.getTableView().getItems().get(t.getTablePosition().getRow())).setExpiryDate(t.getNewValue());
		...
		pricemed.setOnEditCommit((TableColumn.CellEditEvent<Medicine, Float> t) -> {
			try {
		...
		valueMedicine = FXCollections.observableArrayList("mid", "mType", "price", "dosage", "expiryDate", "quantity",
				"cid");
		...
		phnameph.setOnEditCommit((TableColumn.CellEditEvent<Pharmacist, String> t) -> {
			((Pharmacist) t.getTableView().getItems().get(t.getTablePosition().getRow())).setPhname(t.getNewValue());
		...
		contact_infoph.setOnEditCommit((TableColumn.CellEditEvent<Pharmacist, String> t) -> {
			((Pharmacist) t.getTableView().getItems().get(t.getTablePosition().getRow()))
...
// get data from sql 
	...
	void ADDDoctor(javafx.event.ActionEvent actionEvent) {
		...
		Data.insertData(new Doctor(0, nam, sp));
		listcDoctor.clear();
		listcDoctor = FXCollections.observableArrayList(Data.dataDoctor);
		table_Doctor.setItems(listcDoctor);
	}
	...
	void ADDInsurance(javafx.event.ActionEvent actionEvent) {
		...
		String sd = String.valueOf(TIcoverageSdate.getValue());
		String ed = String.valueOf(TIcoverageEdate.getValue());

		Data.insertData(new Insurance(1, type, company, sd, ed));
		listInsurance.clear();
		listInsurance = FXCollections.observableArrayList(Data.dataInsurance);
		table_Insurance.setItems(listInsurance);
	...
	void ADDMedicine(javafx.event.ActionEvent actionEvent) {
		...
		try {
			...
			Data.insertData(new Medicine(0, mType, dosage, expiryDate, price, quantity, cid));
			listMedicine.clear();
			listMedicine = FXCollections.observableArrayList(Data.dataMedicine);
			table_Medicine.setItems(listMedicine);
		} catch (NumberFormatException e) {
	...
	void ADDPharmacist(javafx.event.ActionEvent actionEvent) {
		...
		try {
			...
			Data.insertData(new Pharmacist(0, name, age, gender, contact_info));
